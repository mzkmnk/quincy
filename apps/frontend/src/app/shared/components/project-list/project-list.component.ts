    ...
    <div class="flex-1 flex-col">
      ...
      <div class="flex-shrink-0 p-4 pb-2" [class.p-2]="collapsed()">
        <div class="mb-3" [class.hidden]="collapsed()">
          ...
          @if (appStore.qHistoryLoading()) {
            ...
            <div 
              class="mt-1 text-xs cursor-pointer p-2 bg-[#2d1b24] border border-[#4d2a36] rounded-md text-[#f91880]"
      ...
      >
        @if (appStore.hasAmazonQHistory()) {
          ...
          @if (!collapsed()) {
            <div class="text-center py-8">
              <svg class="w-12 h-12 text-[#f91880] mb-4 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
