...
@Component({
  ...
  template: `
    <nav class="fixed top-0 left-0 right-0 z-50 bg-[#192734] border-b border-[#2f3336]">
      <div class="px-6 h-16 flex items-center justify-between">
        <a routerLink="/chat" class="no-underline">
          <h1 class="text-2xl font-semibold text-white hover:text-[#e7e9ea] transition-colors">Quincy</h1>
        </a>
        ...
        <div class="flex items-center gap-2 text-sm">
          ...
          ></span>
          <span class="text-[#8899ac] font-medium hidden md:inline">
